...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__services_validate_service__ = __webpack_require__(70);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__guards_auth_guard__ = __webpack_require__(107);
...
var LoginComponent = (function () {
    ...
    LoginComponent.prototype.login = function () {
        ...
        this.authService.authenticateUser(userInfo)
    ...
    RegisterComponent.prototype.submitForm = function () {
        ...
        this.authService.register(userInfo)
            ...
            if (data.success) {
                ...
                _this.flashMessage.show("Something went terribly wrong", { cssClass: 'alert-danger', timeout: 3000 });
...
module.exports = "<div class=\"jumbotron text-center\">\n  <h1>Mean Authentication App</h1>\n  <p class=\"lead\">\n    Welcome to our custom MEAN authentication application\n    built from scratch\n  </p>\n  <div>\n    <a [routerLink]=\"['/register']\" class=\"btn btn-primary\">Register</a>\n    <a [routerLink]=\"['/login']\" class=\"btn btn-primary\">Login</a>\n  </div>\n</div>\n<div class=\"row\">\n  <div class=\"col-md-4\">\n    <h3>Express Backend</h3>\n    <p>A rock solid Node.js/Express server using Mongoose to organize models\n    and query the database</p>\n  </div>\n  <div class=\"col-md-4\">\n    <h3>Angular CLI</h3>\n    <p>Angular-CLI to generate components, services and more. Local dev\n    server and easy compilation</p>\n  </div>\n  <div class=\"col-md-4\">\n    <h3>JWT Tokens</h3>\n    <p>FUll featured authentication using JSON web tokens. Login and store\n    user data</p>\n  </div>\n</div>\n"
...
var AuthService = (function () {
    ...
    AuthService.prototype.storeUserData = function (token, user) {
        ...
        //stringify the user because local storage can only store string
...
var ValidateService = (function () {
    ...
    ValidateService.prototype.isFormValid = function (user) {
    ...
    ValidateService.prototype.isEmailValid = function (email) {
